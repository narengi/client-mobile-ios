//
//  SearchDetailAttractionCollectionViewCell.m
//  Narengi
//
...
@implementation SearchDetailAttractionCollectionViewCell
-(void)awakeFromNib{
    ...
    if([UIScreen mainScreen].bounds.size.width > [UIScreen mainScreen].bounds.size.height)
        ...
        size = CGSizeMake((([UIScreen mainScreen].bounds.size.width )/2)-16,  (([UIScreen mainScreen].bounds.size.width)/2 * 5 /8 )-96);
    else
    {
        
        size =CGSizeMake([UIScreen mainScreen].bounds.size.width -16, ( ([UIScreen mainScreen].bounds.size.width) * 5 /8 )-96);
    }
    ...
    self.attractionLabel.layer.cornerRadius  = 5;
    self.attractionLabel.layer.masksToBounds = YES;
...
- (CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout*)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if([UIScreen mainScreen].bounds.size.width > [UIScreen mainScreen].bounds.size.height)
        ...
        return CGSizeMake((([UIScreen mainScreen].bounds.size.width )/2)-16,  (([UIScreen mainScreen].bounds.size.width)/2 * 5 /8 )-96);
    else
    {
        
        return  CGSizeMake([UIScreen mainScreen].bounds.size.width -16, ( ([UIScreen mainScreen].bounds.size.width) * 5 /8 )-96);
    }
